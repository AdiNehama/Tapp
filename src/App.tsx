...
import { MessageCircle, Package, Sliders , TrendingUp, Plug } from 'lucide-react';
import './App.css';
...
function App() {
        ...
        <header className="hero">
          <div className="container">
            ...
            <div className="hero-grid">
              ...
              <h3>
  Bring Your Game to the Home Screen.<br />
  Always Visible.
  Always Played.
</h3>
              </div>
      ...
      <AnimatedSection>
        <section className="widget-showcase">
          <div className="container">
            ...
            {/* <p className="section-description">Experience it for yourself!</p> */}
                ...
                <>
                  ...
                  <div className="feature-list">
                    <div className="feature-item">
                      <h3><TrendingUp size={22} /> Higher Retention</h3>        
                      <p>Widgets of your game draw players in, reducing churn and increasing lifetime value.</p>
                    </div>
                    <div className="feature-item">
                    <h3><Plug size={22} /> Seamless Integration</h3>
                    <p>Our plug-and-play SDK integrates in minutes. Our no-code web platform gives you full control to launch and manage campaigns without a developer.</p>   
                    </div>
                  </div>
                </>
              ) : (
  ...
  <p className="benefit-description">Together, we'll select the optimal widgets for your game</p>
</div>
<div className="benefit-card">
  <Package className="benefit-icon blue" />
  <h3 className="benefit-title">Get a Plug-and-Play SDK</h3>
  <p className="benefit-description">We develop a customized widget based on your use case</p>
</div>
<div className="benefit-card">
  <Sliders className="benefit-icon pink" />
  <h3 className="benefit-title">Manage Everything Remotely</h3>
  <p className="benefit-description">Control your widgets through our no-code web platform, without a developer</p>
</div>
